...
public class HumidityDetails extends AppCompatActivity {
    ...
    private void getActuallData() {
        ...
        ProgressDialog progressDialog = new ProgressDialog(HumidityDetails.this);
        progressDialog.setMessage("Loading data please wait.");
        progressDialog.setCancelable(false);
        progressDialog.show();
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Data");
        lv = (ListView) findViewById(R.id.listHum);
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot pom : snapshot.getChildren()) {
                    ...
                    date = array[9];
                    time = array[10];
                    float pomHum = Float.parseFloat(humidity);
                    String cas = "";
                    String minuty = "";
                    String sekundy = "";
                    ...
                    if (date.equals(datum)&& sekundy.equals(":00")) {
                        String upraveneData = counter + "/" + numberof + " - " + time + " - Humidity %: " + " " + humidity;
    ...
    public void sortHum(View view) {
        final String[] fonts = {
                "None", "Lowest Value", "Highest Value"
        };

        AlertDialog.Builder builder = new AlertDialog.Builder(HumidityDetails.this);
