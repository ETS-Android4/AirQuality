...
public class LPGDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_l_p_g_details);
    ...
    private void getActuallData() {
        ...
        ProgressDialog progressDialog = new ProgressDialog(LPGDetails.this);
        progressDialog.setMessage("Loading data please wait.");
        progressDialog.setCancelable(false);
        progressDialog.show();
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Data");
        lv = (ListView) findViewById(R.id.listLPG);
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot pom : snapshot.getChildren()) {
                    ...
                    date = array[9];
                    time = array[10];
                    float pomHum = Float.parseFloat(LPG);
                    String cas = "";
                    String minuty = "";
                    String sekundy = "";
                    ...
                    if (date.equals(datum)&& sekundy.equals(":00")) {
                        String upraveneData = counter + "/" + numberof + " - " + time + " - value of LPG ppm : " + " " + LPG;
    ...
    public void sortLPG(View view) {
        final String[] fonts = {
                "None", "Lowest Value", "Highest Value"
        };

        AlertDialog.Builder builder = new AlertDialog.Builder(LPGDetails.this);
