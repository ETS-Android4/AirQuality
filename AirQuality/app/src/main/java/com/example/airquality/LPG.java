...
public class LPG extends AppCompatActivity {
    ...
    private static TextView dateLPG;
    private static TextView textCoMaxMinLPG;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_l_p_g);
        barChart = findViewById(R.id.barChartLPG);
        buttonChangeDate = findViewById(R.id.buttonChangeDateLPG);
        textCoMaxMinLPG = findViewById(R.id.textCoMaxMinLPG);
        dateLPG = findViewById(R.id.dateLPG);
        ...
        buttonChangeDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(LPG.this,
                        new DatePickerDialog.OnDateSetListener() {
                            ...
                            public void onDateSet(DatePicker view, int year,
                                ...
                                dateLPG.setText("");
                                dateLPG.setText(year + "-" + pom + "-" + pom_day);
                                MainActivity.setOff();
                                getActuallData();
                            }
                        }, year, month, day);
    ...
    private void getActuallData() {
        ProgressDialog progressDialog = new ProgressDialog(LPG.this);
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot pom : snapshot.getChildren()) {
                    ...
                    time = array[10];
                    String novyCas = time;
                    float pomTemp = Float.parseFloat(LPG);
                    String cas = "";
                    String minuty = "";
                    String sekundy = "";
                    ...
                    if(date.equals(currentDate)){
                        ...
                        textCoMaxMinLPG.setText("Max. Value : " + max + " Min. Value : " + min);
                    }
                    celkovo.add(data);
                    currentDate = dateLPG.getText().toString();
                    if(date.equals(currentDate)&&sekundy.equals(":00")){
                        arrayList.add(data);
                    }
                    if(date.equals(currentDate) && sekundy.equals(":00") && minuty.equals(":00") ){
                        pomTemp = Float.parseFloat(LPG);
                ...
                if(arrayList.size() <= 0){
                    textCoMaxMinLPG.setText("No actual data");
                }
                if(grafik.size() <= 0){
                    barChart.clear();
                    barChart.setNoDataText("No actual data!");
    ...
    public void LPGDetails(View view) {
        String datum = currentDate;
        String graf = numberOfValue + "";
        Intent intent = new Intent(this,LPGDetails.class);
