...
public class Propan extends AppCompatActivity {
    ...
    private static TextView datePropan;
    private static TextView textCoMaxMinPropan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_propan);
        barChart = findViewById(R.id.barChartPropan);
        buttonChangeDate = findViewById(R.id.buttonChangeDatePropan);
        textCoMaxMinPropan = findViewById(R.id.textCoMaxMinPropan);
        datePropan = findViewById(R.id.datePropan);
        ...
        datePropan.setText(currentDate);
        buttonChangeDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(Propan.this,
                        new DatePickerDialog.OnDateSetListener() {
                            ...
                            public void onDateSet(DatePicker view, int year,
                                ...
                                datePropan.setText("");
                                datePropan.setText(year + "-" + pom + "-" + pom_day);
                                MainActivity.setOff();
                                getActuallData();
                            }
                        }, year, month, day);
    ...
    private void getActuallData() {
        ProgressDialog progressDialog = new ProgressDialog(Propan.this);
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot pom : snapshot.getChildren()) {
                    ...
                    time = array[10];
                    String novyCas = time;
                    float pomTemp = Float.parseFloat(propan);
                    String cas = "";
                    String minuty = "";
                    String sekundy = "";
                    ...
                    if(date.equals(currentDate)){
                        ...
                        textCoMaxMinPropan.setText("Max. Value : " + max + " Min. Value : " + min);
                    }
                    celkovo.add(data);
                    currentDate = datePropan.getText().toString();
                    if(date.equals(currentDate)&& sekundy.equals(":00")){
                        arrayList.add(data);
                    }
                    if(date.equals(currentDate) && sekundy.equals(":00") && minuty.equals(":00") ){
                        pomTemp = Float.parseFloat(propan);
                ...
                if(arrayList.size() <= 0){
                    textCoMaxMinPropan.setText("No actual data");
                }
                if(grafik.size() <= 0){
                    barChart.clear();
                    barChart.setNoDataText("No actual data!");
    ...
    public void PropanDetails(View view) {
        String datum = currentDate;
        String graf = numberOfValue + "";
        Intent intent = new Intent(this,PropanDetails.class);
