...
public class TemperatureDetails extends AppCompatActivity {
    ...
    private void getActuallData() {
        ...
        ProgressDialog progressDialog = new ProgressDialog(TemperatureDetails.this);
        progressDialog.setMessage("Loading data please wait.");
        progressDialog.setCancelable(false);
        progressDialog.show();
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Data");
        lv = (ListView) findViewById(R.id.listTemp);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot pom : snapshot.getChildren()) {
                    ...
                    if(date.equals(datum)&&sekundy.equals(":00")){
                        String upraveneData = counter + "/" + numberof + " - " + time + " - Temperature : " + " " + temperature;
    ...
    public void sortTemp(View view) {
        final String[] fonts = {
                "None", "Lowest Value", "Highest Value"
        };

        AlertDialog.Builder builder = new AlertDialog.Builder(TemperatureDetails.this);
