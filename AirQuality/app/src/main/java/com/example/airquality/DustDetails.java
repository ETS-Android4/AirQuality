...
public class DustDetails extends AppCompatActivity {
    ...
    private void getActuallData() {
        ...
        ProgressDialog progressDialog = new ProgressDialog(DustDetails.this);
        progressDialog.setMessage("Loading data please wait.");
        progressDialog.setCancelable(false);
        progressDialog.show();
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Data");
        lv = (ListView) findViewById(R.id.listDust);
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot pom : snapshot.getChildren()) {
                    ...
                    if (date.equals(datum)&& sekundy.equals(":00")&&pomDust >= 0) {
                        String upraveneData = counter + "/" + numberof + " - " + time + " - value of dust u/m3 : " + " " + dust;
    ...
    public void sortPropan(View view) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(DustDetails.this);
