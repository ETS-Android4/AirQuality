...
public class Humidity extends AppCompatActivity {
    ...
    private static TextView dateHum;
    private static TextView textCoMaxMinHum;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        barChart = findViewById(R.id.barChartHum);
        buttonChangeDate = findViewById(R.id.buttonChangeDateHumidity);
        textCoMaxMinHum = findViewById(R.id.textCoMaxMinHum);
        dateHum = findViewById(R.id.dateHumidity);
        ...
        buttonChangeDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(Humidity.this,
                        new DatePickerDialog.OnDateSetListener() {
                            ...
                            public void onDateSet(DatePicker view, int year,
                                ...
                                dateHum.setText("");
                                dateHum.setText(year + "-" + pom + "-" + pom_day);
                                MainActivity.setOff();
                                getActuallData();
                            }
                        }, year, month, day);
    ...
    private void getActuallData() {
        ProgressDialog progressDialog = new ProgressDialog(Humidity.this);
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot pom : snapshot.getChildren()) {
                    ...
                    float pomTemp = Float.parseFloat(humidity);
                    ...
                    if(date.equals(currentDate)){
                        ...
                        textCoMaxMinHum.setText("Max. Value : " + max + " Min. Value : " + min);
                    }
                    celkovo.add(data);
                    currentDate = dateHum.getText().toString();
                    if(date.equals(currentDate)&&sekundy.equals(":00")){
                        arrayList.add(data);
                    }
                    if(date.equals(currentDate) && sekundy.equals(":00") && minuty.equals(":00") ){
                        pomTemp = Float.parseFloat(humidity);
                ...
                if(arrayList.size() <= 0){
                    textCoMaxMinHum.setText("No actual data");
                }
                if(grafik.size() <= 0){
                    barChart.clear();
                    barChart.setNoDataText("No actual data!");
    ...
    public void HumidityDetails(View view) {
        String datum = currentDate;
        String graf = numberOfValue + "";
        Intent intent = new Intent(this,HumidityDetails.class);
